export default function (id){
    ...
    var col = ['#ffff80','#80ffff','#8080ff','#ff80ff'];
    resize();
...
// 每一帧循环的逻辑
    function animate() {
        ...
        dots.forEach(function (dot) {
            ...
            ctx.beginPath();
            ctx.arc(dot.x - 0.5, dot.y - 0.5,3,0,2*Math.PI);
...
export function CasBackground(id){
    var canvasPage3 = document.getElementById(id);
